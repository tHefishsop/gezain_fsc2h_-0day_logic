...
2.	Panic Signature: Successful triggers should result in a Fatal trap 12: page fault in kernel mode, where the faulting address points to the controlled heap spray payload.
